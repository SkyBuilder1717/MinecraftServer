...
class ThreadLoginVerifier extends Thread {
	...
	public void run() {
		try {
			...
			URL var2 = new URL("http://session.minecraft.net/game/checkserver.jsp?user=" + this.loginPacket.username + "&serverId=" + var1);
			...
			if(var4.equals("YES")) {
                ...
                for (EventListener l : loginHandler.mcServer.pluginManager.getListeners()) {
                    l.onPlayerLogin(this.loginPacket.username);
                }
			} else {
